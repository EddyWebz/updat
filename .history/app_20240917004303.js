...
const app = express();
const SECRET_KEY = 'c7b226554f4666a11164ac960f8f807b140116defe512e297e73d1b04a043231';  // Cambia esto a una clave segura
...
// Mostrar el formulario de inicio de sesión cuando se accede a /login
app.get('/login', (req, res) => {
    res.sendFile(path.join(__dirname, 'BASE-2', 'index.html'));  // Asegúrate que la ruta a tu archivo index.html es correcta
});
...
function authenticateToken(req, res, next) {
    ...
    jwt.verify(token, SECRET_KEY, (err, user) => {
        ...
        req.user = user;  // Si el token es válido, continuar
        next();
    });
}
