...
router.get('/eventos', verifyJWT, async (req, res) => {
    try {
        ...
        if (!startDate || !endDate) {
           ...
           // Log para mostrar el rango de fechas predeterminado
           console.log('Usando fechas predeterminadas:', { startDate, endDate });
        }
        ...
        const [eventos] = await connection.query(
         ...
         // Log para ver cuántos eventos se obtuvieron
