...
function showFullscreenImages(images, index = 0) {
    ...
    if (images.length > 1) { // Solo mostrar los botones si hay más de una imagen
          // Botón Anterior con icono FontAwesome
          const prevButton = document.createElement('button');
          prevButton.className = 'fullscreen-prev';
          prevButton.innerHTML = '<i class="fas fa-chevron-left"></i>'; // Icono FontAwesome para "anterior"
      ...
      // Botón Siguiente con icono FontAwesome
      const nextButton = document.createElement('button');
      nextButton.className = 'fullscreen-next';
      nextButton.innerHTML = '<i class="fas fa-chevron-right"></i>'; // Icono FontAwesome para "siguiente"
