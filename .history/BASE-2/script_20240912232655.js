...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function saveFormData() {
        ...
        console.log('Datos guardados en Local Storage:', formData);  // Debugging, solo mostrar una vez al guardar
    }
    ...
    function loadFormData() {
        ...
        if (savedData) {
            ...
            console.log('Datos cargados desde Local Storage:', formData); // Mostrar lo que se carga solo al inicio
