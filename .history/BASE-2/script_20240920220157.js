...
async function loadFormData() {
    ...
    if (savedData) {
        ...
        // Verificar si han pasado 40 minutos desde que se guardaron los datos
        if (currentTime - formData.timestamp > fortyMinutes) {
            console.log('Los datos han expirado. Eliminando datos del Local Storage.');
            ...
            // Rellenar el formulario con los datos almacenados
