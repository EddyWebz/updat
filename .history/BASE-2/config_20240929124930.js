            ...
            imgElement.dataset.index = index; // Guardar el índice de la imagen
               ...
               imgElement.addEventListener('click', () => {
                   ...
                   if (imagesToReplace.includes(imageUrl)) {
                       // Si ya está seleccionada para reemplazar, deseleccionarla
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    ddocument.getElementById('vehicleEditForm').addEventListener('submit', async (e) => {
    e.preventDefault();
    ...
    // Verificar si se seleccionaron imágenes para reemplazar y se cargaron nuevas imágenes
    ...
    if (imagesToReplace.length > 0) {
        ...
        if (files.length > 0) {
            alert('No has seleccionado ninguna imagen existente para reemplazar, pero has cargado nuevas imágenes. Por favor, selecciona las imágenes que deseas reemplazar.');
            return;
        }
    }
