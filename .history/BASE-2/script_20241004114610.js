...
const translations = {
    ...
    vehicleForm.addEventListener('submit', async (e) => {
        ...
        // Selecciona el contenedor del formulario y crea un elemento de barra de progreso
const progressBar = document.createElement('div');
progressBar.classList.add('progress-bar');
const progressBarFill = document.createElement('div');
progressBarFill.classList.add('progress-bar-fill');
progressBar.appendChild(progressBarFill);
vehicleForm.appendChild(progressBar); // Agrega la barra al formulario

// Función para manejar la barra de carga
...
// Modificar el envío de formulario
vehicleForm.addEventListener('submit', async (e) => {
    e.preventDefault();
    const isAuthenticated = await checkAuthentication();
    ...
    // Configura el XHR para poder rastrear el progreso
    const xhr = new XMLHttpRequest();
    xhr.upload.addEventListener('progress', updateProgressBar); // Asigna el evento de progreso
    ...
    xhr.onload = () => {
        if (xhr.status === 200) {
            ...
            if (response.success) {
                ...
                progressBarFill.style.width = '0%'; // Reiniciar barra de progreso
