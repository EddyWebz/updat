document.addEventListener('DOMContentLoaded', function() {
    ...
    // Función para obtener las fechas seleccionadas (manuales o por defecto)
    function getSelectedDates() {
        let startDate = startDateInput.value;
        let endDate = endDateInput.value;

        // Si no se seleccionan fechas, usar un rango predeterminado (últimos 7 días)
    ...
    // Evento de clic para aplicar el filtro de fechas
