...
function getCookie(name) {
    ...
    return null; // Asegurarse de que retorne null si no existe la cookie
}
...
function saveFormData() {
    ...
    if (!userId) {
        console.error('No se encontró user_id en las cookies. No se puede guardar el formulario.');
        return; // Detener si no hay user_id
    }
