document.addEventListener('DOMContentLoaded', () => {
    ...
    const secciones = [editarContent, sesionContent, nosotrosContent];
        ...
        editarBtn.addEventListener('click', async () => { toggleSeccion(editarContent);
        });
       // Evento para desplegar el contenido de Configuración de Sesión
       sesionBtn.addEventListener('click', async () => { toggleSeccion(sesionContent);
    });

      // Evento para desplegar el contenido de Sobre Nosotros
      nosotrosBtn.addEventListener('click', async () => { toggleSeccion(nosotrosContent);
    });
