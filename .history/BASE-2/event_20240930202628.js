document.addEventListener('DOMContentLoaded', function() {
    ...
    // Añadir eventos de cambio para asegurarse de que los valores se actualicen correctamente
    startDateInput.addEventListener('change', function() {
        console.log('Fecha de inicio seleccionada:', startDateInput.value);
    });

    endDateInput.addEventListener('change', function() {
        console.log('Fecha de fin seleccionada:', endDateInput.value);
    });
