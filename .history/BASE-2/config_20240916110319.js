...
function openEditForm(vehicle) {
    ...
    imageInput.value = '';  // Resetear el campo de archivo
      ...
      // Limpiar el campo oculto de imágenes existentes
      const existingImagesField = document.getElementById('existingImages');
      existingImagesField.value = '';  // Limpiar el campo oculto para evitar enviar imágenes de ediciones previas
   ...
   // Mostrar las imágenes actuales en el formulario de edición
    ...
    if (vehicle.images && vehicle.images.length > 0) {
     ...
     // Almacenar las imágenes actuales en el campo oculto solo para este vehículo
