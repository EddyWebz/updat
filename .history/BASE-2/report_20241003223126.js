...
// Función para mostrar el comentario debajo de la placa
function mostrarComentario(id, comentario) {
    ...
    if (celdaPlaca) {
        ...
        if (comentario) {  // Solo mostrar el comentario si está definido
            ...
            // Si no hay comentario, mostrar un texto vacío o predeterminado
            if (comentarioExistente) {
                comentarioExistente.innerText = '';  // Texto vacío si no hay comentario
            }
        }
    } else {
        console.error(`La celda con el id ${id} no se encontró en el DOM`);
