...
document.getElementById('vehicleForm').addEventListener('submit', async (e) => {
    ...
    if (submitButton.disabled) {
        console.log("Envío bloqueado: el botón está deshabilitado.");
    ...
    if (currentTime - lastSubmissionTime < 10000) {
        console.log("Envío bloqueado: Debes esperar 10 segundos antes de enviar nuevamente.");
    ...
    if (clickTimeout) {
        console.log("Clic bloqueado: Ya se ha enviado el formulario, espera 10 segundos.");
        return; // Ignoramos el clic si está dentro del tiempo de espera
    }

    clickTimeout = true;
    console.log("Clics adicionales bloqueados durante 10 segundos.");
    setTimeout(() => {
    ...
    xhr.onload = () => {
        ...
        console.log("Botón habilitado después del envío");
    };
    ...
    xhr.onerror = () => {
        ...
        console.log("Error de conexión. Botón habilitado nuevamente.");
    };
