...
function saveFormData() {
    ...
    // Guardar en el Local Storage sin asociar a un userId
...
function loadFormData() {
    const savedData = localStorage.getItem('vehicleFormData'); // Obtener datos sin usar userId
    if (savedData) {
        ...
        if (currentTime - formData.timestamp > 30 * 60 * 1000) {
            ...
            localStorage.removeItem('vehicleFormData'); // Eliminar los datos si han expirado
            return;
        }
...
document.getElementById('vehicleForm').addEventListener('submit', () => {
    localStorage.removeItem('vehicleFormData');  // Eliminar los datos guardados
