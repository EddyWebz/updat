...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function saveFormData() {
        ...
        console.log('Datos guardados en Local Storage:', formData);  // Mostrar lo que se guarda
    }
    ...
    function loadFormData() {
        ...
        if (savedData) {
            ...
            console.log('Datos cargados desde Local Storage:', formData); // Mostrar lo que se carga
    ...
    formElements.forEach(element => {
        element.addEventListener('input', () => {
            console.log(`Valor actualizado en el campo ${element.id}:`, element.value);  // Verificar qué valor se actualiza
            saveFormData();  // Guardar datos cada vez que se cambia algo
        });
    });
