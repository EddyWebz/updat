...
/const verifyJWT = (req, res, next) => {
    ...
    jwt.verify(token, secretKey, (err, decoded) => {
        ...
        // Guardar el userId y el rol en el objeto req para usarlos en otras rutas
        req.userId = decoded.userId;
        req.role = decoded.role;  // Extraer el rol del token

        console.log(`Token verificado correctamente, userId: ${req.userId}, role: ${req.role}`);
        next();
    });
};
// VERIFICAR ROLES
