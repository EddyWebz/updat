...
// Función para convertir UTC a la zona horaria local
function convertirUTCaLocal(utcDate, timezone = 'America/Guayaquil') {
...
router.get('/notificaciones', verifyJWT, async (req, res) => {
    ...
    try {
        ...
        notificaciones.forEach(registro => {
            ...
            if (verificarNotificacionVehiculo(horaIngresoLocal)) {
